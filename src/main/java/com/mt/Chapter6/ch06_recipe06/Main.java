package com.mt.Chapter6.ch06_recipe06;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Map to double
        System.out.printf("********************************************************\n");
        DoubleStream ds = persons.parallelStream().mapToDouble(Person::getSalary);
        ds.distinct().forEach(d -> {
            System.out.printf("Salary: %f\n", d);
        });
        ds = persons.parallelStream().mapToDouble(Person::getSalary);
